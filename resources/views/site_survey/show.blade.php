...
@section('content')
    ...
    <h3 class="mt-3">Site Survey Information</h3>
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <div class="invalid-feedback" id="nama_pe_error" style="display: none;">Nama PE is required.</div>
                </div>
            </div>
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <div class="invalid-feedback" id="kawasan_error" style="display: none;">Kawasan is required.</div>
                </div>
            </div>
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="fl" name="fl" value="{{ $siteSurvey->fl ?? old('fl') }}"  disabled>
        </div>
        </div>
        <div class="col-md-6">
        <div class="form-group">
    ...
    <label style="display: inline-block;">
        ...
        <div class="col-md-6">
                ...
                <option value="" disabled>Pilih Jenis Kompaun</option>
        ...
        <div class="col-md-6">       
            ...
            <select class="form-control" id="jenis_perkakasuis" name="jenis_perkakasuis">
                <option value="" disabled>Jenis Perkakasuis</option>
                        ...
                        <div id="{{ $field }}_images" style="{{ (isset($siteSurvey1) && $siteSurvey1->$field == 'yes') ? '' : 'display: none;' }}">
                            @for ($i = 1; $i <= ($field == 'other' ? 4 : 2); $i++)
                                <div class="form-group">
                                    ...
                                    <input type="file"  disabled class="form-control-file" id="{{ $field }}_image{{ $i }}" name="{{ $field }}_image{{ $i }}">
    ...
    <div class="form-group">
        ...
        <label for="lokasi_yes">
            <input type="radio"  disabled id="lokasi_yes" name="lokasi" value="yes" style="appearance: radio; -webkit-appearance: radio; -moz-appearance: radio; width: auto; display: inline-block; margin-right: 5px;" {{ ($toolboxTalk->lokasi ?? old('lokasi')) === 'yes' ? 'checked' : '' }}>
            Yes
        </label>
        <label for="lokasi_no">
            <input type="radio" disabled id="lokasi_no" name="lokasi" value="no" style="appearance: radio; -webkit-appearance: radio; -moz-appearance: radio; width: auto; display: inline-block; margin-right: 5px;" {{ ($toolboxTalk->lokasi ?? old('lokasi')) === 'no' ? 'checked' : '' }}>
            No
        </label>
    </div>
...
<div class="col-md-6">
    ...
    <div class="form-group">
        ...
        <label for="cfs_yes">
            <input type="radio" disabled id="cfs_yes" name="cfs" value="yes" style="appearance: radio; -webkit-appearance: radio; -moz-appearance: radio; width: auto; display: inline-block; margin-right: 5px;" {{ ($toolboxTalk->cfs ?? old('cfs')) === 'yes' ? 'checked' : '' }}>
            Yes
        </label>
        <label for="cfs_no">
            <input type="radio" disabled id="cfs_no" name="cfs" value="no" style="appearance: radio; -webkit-appearance: radio; -moz-appearance: radio; width: auto; display: inline-block; margin-right: 5px;" {{ ($toolboxTalk->cfs ?? old('cfs')) === 'no' ? 'checked' : '' }}>
            No
        </label>
    </div>
    ...
    <div class="form-group">
        ...
        <label for="skop_kerja_yes">
            <input type="radio" disabled id="skop_kerja_yes" name="skop_kerja" value="yes" style="appearance: radio; -webkit-appearance: radio; -moz-appearance: radio; width: auto; display: inline-block; margin-right: 5px;" {{ ($toolboxTalk->skop_kerja ?? old('skop_kerja')) === 'yes' ? 'checked' : '' }}>
            Yes
        </label>
        <label for="skop_kerja_no">
            <input type="radio"  disabled id="skop_kerja_no" name="skop_kerja" value="no" style="appearance: radio; -webkit-appearance: radio; -moz-appearance: radio; width: auto; display: inline-block; margin-right: 5px;" {{ ($toolboxTalk->skop_kerja ?? old('skop_kerja')) === 'no' ? 'checked' : '' }}>
            No
        </label>
    </div>
    ...
    @foreach(['ppd_safety_helment', 'ppd_safety_vest', 'ppd_safety_shoes', 'ppd_safety'] as $field)
        <div class="form-group">
            ...
            <label for="{{ $field }}_yes">
                <input type="radio"  disabled id="{{ $field }}_yes" name="{{ $field }}" value="yes" style="appearance: radio; -webkit-appearance: radio; -moz-appearance: radio; width: auto; display: inline-block; margin-right: 5px;" {{ ($toolboxTalk->$field ?? old($field)) === 'yes' ? 'checked' : '' }}>
                Yes
            </label>
            <label for="{{ $field }}_no">
                <input type="radio"  disabled id="{{ $field }}_no" name="{{ $field }}" value="no" style="appearance: radio; -webkit-appearance: radio; -moz-appearance: radio; width: auto; display: inline-block; margin-right: 5px;" {{ ($toolboxTalk->$field ?? old($field)) === 'no' ? 'checked' : '' }}>
                No
            </label>
        </div>
    @endforeach
    ...
    <div class="form-group">
        ...
        <label for="picture_during_toolbox_yes">
            <input type="radio" disabled id="picture_during_toolbox_yes" name="picture_during_toolbox" value="yes" style="appearance: radio; -webkit-appearance: radio; -moz-appearance: radio; width: auto; display: inline-block; margin-right: 5px;" {{ ($toolboxTalk->picture_during_toolbox ?? old('picture_during_toolbox')) === 'yes' ? 'checked' : '' }}>
            Yes
        </label>
        <label for="picture_during_toolbox_no">
            <input type="radio" disabled id="picture_during_toolbox_no" name="picture_during_toolbox" value="no" style="appearance: radio; -webkit-appearance: radio; -moz-appearance: radio; width: auto; display: inline-block; margin-right: 5px;" {{ ($toolboxTalk->picture_during_toolbox ?? old('picture_during_toolbox')) === 'no' ? 'checked' : '' }}>
            No
        </label>
    </div>
       ...
       <div class="form-group">
        ...
        <label for="upload_images_yes">
            <input type="radio" disabled id="upload_images_yes" name="upload_images" value="yes"  style="appearance: radio; -webkit-appearance: radio; -moz-appearance: radio; width: auto; display: inline-block; margin-right: 5px;" onclick="toggleImageInputs(true)">
            Yes
        </label>
        <label for="upload_images_no">
            <input type="radio"  disabled id="upload_images_no" name="upload_images" value="no"  style="appearance: radio; -webkit-appearance: radio; -moz-appearance: radio; width: auto; display: inline-block; margin-right: 5px;"onclick="toggleImageInputs(false)">
            No
        </label>
    </div>
...
function toggleDateInput(show) {
        document.getElementById('date_input').style.display = show ? 'block' : 'none';
    }

    // Initialize the display based on the default checked value
    document.addEventListener('DOMContentLoaded', function() {
        const tarikhYes = document.getElementById('tarikh_yes').checked;
        toggleDateInput(tarikhYes);
    });
...
function validateImageUploads() {
    ...
    // Iterate over each field and check if images are uploaded when "Yes" is selected
    pictureFields.forEach(field => {
        const yesRadio = document.querySelector(`input[name="${field}"][value="yes"]`);
        if (yesRadio && yesRadio.checked) {
            // Check if any required file input is empty
            for (let i = 1; i <= (field === 'other' ? 4 : 2); i++) {
                const fileInput = document.getElementById(`${field}_image${i}`);
                if (fileInput && fileInput.value === '') {
                    fileInput.classList.add('is-invalid'); // Highlight missing input
                    isValid = false;
                } else {
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.getElementById('nextBtn').addEventListener('click', function() {
        const namaPe = document.getElementById('nama_pe');
        const kawasan = document.getElementById('kawasan');
        let isValid = true;

        // Validate text inputs (as in your original code)
        if (!namaPe.value.trim()) {
            document.getElementById('nama_pe_error').style.display = 'block';
            namaPe.classList.add('is-invalid');
            isValid = false;
        } else {
            document.getElementById('nama_pe_error').style.display = 'none';
            namaPe.classList.remove('is-invalid');
        }

        if (!kawasan.value.trim()) {
            document.getElementById('kawasan_error').style.display = 'block';
            kawasan.classList.add('is-invalid');
            isValid = false;
        } else {
            document.getElementById('kawasan_error').style.display = 'none';
            kawasan.classList.remove('is-invalid');
        }

        // Validate image uploads if "Yes" is selected
